...
{
    /// <summary>
    /// Generates a new OR-CamlQuery-Element, linking an Array of Elements together using OR-Statements.
    /// </summary>
    public class Or : ICamlQueryElement
    {
        /// <summary>
        ...
        /// <summary>
        /// Links two or more Elements together using an OR-Statement.
        /// </summary>
        /// <param name="a">The first Element to link.</param>
        /// <param name="b">Additional optional Elements to link.</param>
        public Or(ICamlQueryElement a, params ICamlQueryElement[] b)
        {
            //Validations
            if (a == null)
            {
        ...
        /// <summary>
        /// Links an Array of Elements together using an OR-Statement.
        /// </summary>
        /// <param name="elements">The List of Elements. Must at least containt 1 Element.</param>
        public Or(IEnumerable<ICamlQueryElement> elements)
        {
            //Validations
        ...
        public string ToCamlQueryString()
        {
            if (b != null)
            {
                return $"<Or>{a.ToCamlQueryString()}{b.ToCamlQueryString()}</Or>";
            }
            else
            {
        ...
        private void Init(List<ICamlQueryElement> elements)
        {
            ...
            else
            {
                ...
                a = elements[0];
                b = new Or(elements.Skip(1).ToArray());
            }
        }
    }
}
